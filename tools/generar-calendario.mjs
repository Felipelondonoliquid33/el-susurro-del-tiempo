...
<div class="hero"><p class="kicker">El Susurro del Tiempo</p><h1>Calendario de publicación</h1><p class="sub">33 Reels · 4 por semana · ~2 meses</p><p class="meta">Empieza el ${entries[0].diaLabel} · ${entries[0].time} COT</p></div>
...
console.log(`  Fin:    ${entries[32].diaLabel} ${entries[32].time} - ${entries[32].file}`);
